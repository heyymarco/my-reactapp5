...
export const keyframesEnable   = { from: undefined, to: undefined } as unknown as Css.Keyframes;
export const keyframesDisable  = { from: undefined, to: undefined } as unknown as Css.Keyframes;
