...
export const keyframesBackgActive  = { from: undefined, to: undefined } as unknown as Css.Keyframes;
export const keyframesBackgPassive = { from: undefined, to: undefined } as unknown as Css.Keyframes;
